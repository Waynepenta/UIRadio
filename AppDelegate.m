...
//    UINavigationController *leftVC = [[UINavigationController alloc] initWithRootViewController:left];
    
    MMDrawerController *mmdVC = [[MMDrawerController alloc] initWithCenterViewController:rootVC leftDrawerViewController:left];
    ...
    _window.rootViewController = mmdVC;
